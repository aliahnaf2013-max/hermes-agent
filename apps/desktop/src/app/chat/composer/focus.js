...
export const getActiveComposer = () => activeTarget;
...
export const requestVoiceToggle = (target = 'active') => dispatch(VOICE_TOGGLE_EVENT, { target: resolve(target) });
export const onComposerVoiceToggleRequest = (handler) => subscribe(VOICE_TOGGLE_EVENT, ({ target }) => handler(target));
/**
