...
import { $composerPopoutPosition, $composerPoppedOut, readPopoutBounds, setComposerPopoutPosition, setComposerPoppedOut } from '@/store/composer-popout';
 ...
 */
export function useComposerPopout({ composerRef }) {
    ...
    const { dockProximity, dragging, onPointerDown: onComposerGesturePointerDown } = useComposerPopoutGestures({
        composerRef,
