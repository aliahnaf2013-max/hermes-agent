...
export function PetOverlayApp() {
    ...
    const clickTimerRef = useRef(undefined);
    ...
    const onScale = useCallback((next, anchor) => {
    ...
    useEffect(() => {
        ...
        const { width, height } = overlayWindowSize(info.frameW ?? DEFAULT_FRAME_W, info.frameH ?? DEFAULT_FRAME_H, info.scale ?? DEFAULT_SCALE);
    ...
    return (_jsxs("div", { onPointerDown: e => {
            ...
            userSelect: 'none',
            width: '100vw'
        }, children: [composerOpen && (_jsx("input", { onChange: e => setDraft(e.target.value), onKeyDown: e => {
                ...
                }, placeholder: "Message\u2026", ref: inputRef, style: {
                    ...
                    padding: '4px 8px',
                    width: 184
                }, value: draft })), _jsxs("div", { onPointerDown: onPetPointerDown, onPointerMove: onPetPointerMove, onPointerUp: onPetPointerUp, ref: petRef, style: {
                    alignItems: 'center',
                    cursor: 'grab',
                    display: 'flex',
                    flexDirection: 'column',
                    position: 'relative',
                    touchAction: 'none'
                }, children: [_jsx("div", { style: { marginBottom: 4 }, children: _jsx(PetBubble, {}) }), _jsxs("div", { style: { lineHeight: 0, position: 'relative' }, children: [_jsx(PetSprite, { info: info }), _jsx(PetHeartField, { petH: (info.frameH ?? DEFAULT_FRAME_H) * (info.scale ?? DEFAULT_SCALE), petW: (info.frameW ?? DEFAULT_FRAME_W) * (info.scale ?? DEFAULT_SCALE) }), unread && (_jsx("button", { "aria-label": "Open in Hermes", onClick: openApp, onPointerDown: e => e.stopPropagation(), onPointerUp: e => e.stopPropagation(), style: {
                                    alignItems: 'center',
                                    background: 'var(--ui-bg-elevated)',
                                    border: '1px solid var(--ui-stroke-secondary)',
                                    borderRadius: 999,
