import { Box, Brain, Lock, MessageCircle, Mic, Monitor, Moon, Palette, Sun, Wrench } from '@/lib/icons';
...
export const FIELD_LABELS = defineFieldCopy({
    model: 'Default Model',
...
export const FIELD_DESCRIPTIONS = defineFieldCopy({
    ...
    updates: {
        nonInteractiveLocalChanges: 'When Hermes updates itself from the app (no terminal prompt), keep local source edits (stash) or throw them away (discard). Terminal updates always ask.'
    }
});
