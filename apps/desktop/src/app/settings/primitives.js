...
export function SettingsContent({ children, bare = false }) {
    return (_jsx("section", { className: "min-h-0 overflow-hidden", children: _jsx("div", { className: cn('h-full min-h-0 overflow-y-auto', bare ? 'px-5 pb-6' : cn('pb-20', PAGE_INSET_X)), children: children }) }));
}
