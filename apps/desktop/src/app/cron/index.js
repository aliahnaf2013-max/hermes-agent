...
function CronEditorDialog({ editor, onClose, onSave }) {
    ...
    async function handleSubmit(event) {
        ...
        if (validationError) {
            setError(validationError === 'schedule'
                ? c.scheduleRequired
