...
export function TreeEditBar() {
    ...
    return (_jsxs("div", { className: "absolute z-50 flex w-[26rem] max-w-[calc(100%-2rem)] flex-col rounded-xl border border-(--ui-stroke-secondary) bg-popover text-popover-foreground shadow-2xl [-webkit-app-region:no-drag]", ref: cardRef, style: pos ? { left: pos.x, top: pos.y } : { left: '50%', top: '50%', transform: 'translate(-50%, -50%)' }, children: [_jsxs("header", { className: "flex shrink-0 cursor-grab select-none items-start justify-between gap-3 px-4 pb-2 pt-3 active:cursor-grabbing", onPointerDown: startMove, children: [_jsxs("div", { className: "min-w-0", children: [_jsx("h2", { className: "text-sm font-semibold text-foreground", children: t.zones.editTitle }), _jsxs("p", { className: "text-xs text-muted-foreground/80", children: [t.zones.editHint, ' ', toggleCombo && (_jsx("kbd", { className: "rounded border border-(--ui-stroke-secondary) bg-foreground/5 px-1 font-mono text-[10px]", children: formatCombo(toggleCombo) }))] })] }), _jsxs("div", { className: "flex shrink-0 items-center gap-1.5", onPointerDown: e => e.stopPropagation(), children: [_jsx(Button, { onClick: resetLayoutTree, size: "sm", variant: "ghost", children: t.zones.reset }), _jsx(Button, { onClick: () => $layoutEditMode.set(false), size: "sm", variant: "outline", children: t.common.done })] })] }), _jsx("div", { className: "px-4 pb-4", children: _jsx(LayoutPicker, {}) })] }));
}
