...
export function LayoutTreeRoot({ children }) {
    ...
    return (_jsxs("div", { className: "relative flex min-h-0 min-w-0 flex-1", children: [_jsx("style", { children: `@keyframes hermes-zone-fade { from { opacity: 0.001 } to { opacity: 1 } }` }), _jsx("style", { children: `
      ...
      ` }), _jsx(TreeNode, { node: tree, root: true }), _jsx(NarrowOverlays, {}), _jsx(TreeEditBar, {}), _jsx(ZoneEditor, {}), children] }));
}
