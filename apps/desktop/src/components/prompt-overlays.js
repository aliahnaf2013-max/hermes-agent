...
function SecretDialog({ sessionId }) {
    const { t } = useI18n();
    const copy = t.prompts;
...
export function PromptOverlays({ sessionId }) {
    return (_jsxs(_Fragment, { children: [_jsx(PendingApprovalFallback, {}), _jsx(SudoDialog, { sessionId: sessionId }), _jsx(SecretDialog, { sessionId: sessionId })] }));
}
