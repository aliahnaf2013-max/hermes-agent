...
export function createComposerAttachmentScope($attachments = atom([])) {
    return {
        $attachments,
        add(attachment) {
...
export const addComposerAttachment = (attachment) => mainComposerScope.add(attachment);
export const removeComposerAttachment = (id) => mainComposerScope.remove(id);
...
export const updateComposerAttachment = (attachment) => mainComposerScope.update(attachment);
...
export const setComposerAttachmentUploadState = (id, uploadState) => mainComposerScope.setUploadState(id, uploadState);
