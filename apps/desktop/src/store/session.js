...
export const getRememberedRoute = () => storedString(LAST_ROUTE_KEY);
export const setRememberedRoute = (path) => persistString(LAST_ROUTE_KEY, path);
...
export const sessionMatchesStoredId = (session, storedSessionId) => session.id === storedSessionId || session._lineage_root_id === storedSessionId;
