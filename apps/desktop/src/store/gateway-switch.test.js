...
import { $cronSessions, $freshDraftReady, $messagingSessions, $sessions, $sessionsLoading, $sessionsTotal, setCronSessions, setFreshDraftReady, setMessagingSessions, setSessions, setSessionsLoading, setSessionsTotal } from '@/store/session';
...
describe('wipeSessionListsForGatewaySwitch', () => {
    beforeEach(() => {
        ...
        setSessions([{ id: 's1', title: 'old', profile: 'default' }]);
        setSessionsTotal(1);
        setCronSessions([{ id: 'c1', title: 'cron', profile: 'default' }]);
        setMessagingSessions([{ id: 'm1', title: 'tg', profile: 'default' }]);
